...
def posgres_client_from_connection_parameters(user, password, host, port, db_name):
...
def posgres_client_from_connection_os_variable(db_uri_os_valiable_name='LOCAL_PG_DB_URI'):
